...
@isset($sku)
    @section('title', 'Redaguoti Sku ' . $sku->name)
@else
    @section('title', 'Sukurti Sku')
@endisset

@section('content')
    <div class="col-md-12">
        @isset($sku)
            <h1>Redaguoti Sku <b>{{ $sku->name }}</b></h1>
        @else
            <h1>Sukurti Sku</h1>
        @endisset
        ...
        >
            <div>
                ...
                <div class="input-group row">
                    <label for="price" class="col-sm-4 col-form-label">Kaina: </label>
                    <div class="col-sm-6">
                ...
                <div class="input-group row">
                    <label for="count" class="col-sm-4 col-form-label">Kiekis: </label>
                    <div class="col-sm-6">
